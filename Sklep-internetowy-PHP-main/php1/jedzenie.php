...
<body>
	...
	<ul>
		...
		<li  class="active"><a href="jedzenie.php">Jedzenie </a><i class="fas fa-utensils"></i></li>
	...
	<?php
		$sql = "SELECT * FROM produkt WHERE Kategoria='jedzenie'";
		...
		while($row = $rezultat->fetch_assoc()) 
		{
			...
			echo '			<input type="hidden" name="kategoria" value="jedzenie"/>';
