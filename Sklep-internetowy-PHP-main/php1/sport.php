...
<body>
	...
	<ul>
		...
		<li class="active"><a href="sport.php">Sport </a><i class="fa fa-volleyball-ball"></i></li>
	...
	<?php
		$sql = "SELECT * FROM produkt WHERE Kategoria='sport'";
		...
		while($row = $rezultat->fetch_assoc()) 
		{
			...
			echo '			<input type="hidden" name="kategoria" value="sport"/>';
