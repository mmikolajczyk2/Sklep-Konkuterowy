...
<body>
	...
	<ul>
		...
		<li class="active"><a href="elektronika.php">Elektronika </a><i class="fas fa-tv"></i></li>
	...
	<?php
		$sql = "SELECT * FROM produkt WHERE Kategoria='elektronika'";
		...
		while($row = $rezultat->fetch_assoc()) 
		{
			...
			echo '			<input type="hidden" name="kategoria" value="elektronika"/>';
	...
	<div class="container">
		<div class="containerForImage">
			<img src="kijgolfowy.jpg" class="image">
		</div>
		<div class="containerForText">
			<p><b><u>Kij golfowy</u></b></p>
			<div class="price"><p><b> 17.99 zł</b></p></div>
			<div class="description">
				[TUTAJ jest miejsce na przykładowy opis]. Który zawieral by do około 200 znaków.
			</div>
			<div class="purchase">
				<input type="number" min="0" step="1" name="ilosc" placeholder="0"> 
			</div>	
			<div class="okbutton">
